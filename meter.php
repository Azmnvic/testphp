...
<body>
  ...
  <div class="topnav">
    ...
    <section class="projectback" id="pjctpage">

        <div class="content">   
            <ol class="breadcrumb"><li><i class="fas fa-home"></i><a href="./index.php" class="Home1">Home</a></li><li class="active"><span class="table1">Project</span></li></ol>   
        </div>
